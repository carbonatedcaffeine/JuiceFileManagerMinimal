...
a file manager made from just python code and made for linux minimal

How To Install
Download installJuice.py

python3 installJuice.py And Follow Instructions

to launch juicefilemanager type python3 juicefilemanager4.0.py (in the dir you installed into)
