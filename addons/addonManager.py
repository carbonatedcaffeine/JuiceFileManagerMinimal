...
''')
  ...
  os.system("wget https://raw.githubusercontent.com/EnderNightLord-ChromeBook/JuiceFileManagerMinimal/AddonManager/addonsAssets/AdminOptions.py -P ~/Downloads/JFM/Assets")
  ans = input('''
==============================
JuiceFileManager Addon Manager
==============================
...
''')
  ...
  os.system("wget https://raw.githubusercontent.com/EnderNightLord-ChromeBook/JuiceFileManagerMinimal/AddonManager/addonsAssets/AdminOptions.py -P /root/JFM/Assets")
  ans = input('''
==============================
JuiceFileManager Addon Manager
==============================
...
''')
  ...
  os.system("wget https://raw.githubusercontent.com/EnderNightLord-ChromeBook/JuiceFileManagerMinimal/AddonManager/addonsAssets/AdminOptions.py -P /JFM/Assets")
  ans = input('''
==============================
JuiceFileManager Addon Manager
==============================
